...
game.state.add('predatorState', predatorState);
...
function gameOver() {
    ...
    organelas.acertos = organelas.acertos.toString();
...
function levelSuccess() {
    ...
    organelas.erros = organelas.erros.toString();
    organelas.acertos = organelas.acertos.toString();
    reg.modal.updateModalValue(organelas.acertos, 'gameSucessModal', 1);
    reg.modal.updateModalValue(organelas.erros, 'gameSucessModal', 2);
